...
/// A typedef for a typed [TypedTextInputPageObject] representing a [TextField].
typedef TypedTextFieldPageObject<T> = TypedTextInputPageObject<T>;
...
extension TypedTextFieldPageObjectFactoryExtension<K> on PageObjectFactory<K> {
  ...
  TypedTextFieldPageObject<T> typedTextField<T>(
    K key, {
